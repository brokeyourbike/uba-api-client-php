...
use BrokeYourBike\UnitedBank\Enums\ChannelTypeEnum;

/**
 * @author Ivan Stasiuk <brokeyourbike@gmail.com>
 */
class ChannelTypeEnumTest extends TestCase
{
    /** @test */
    public function it_extends_myclabs_enum(): void
    {
        $parent = get_parent_class(ChannelTypeEnum::class);
    ...
    {
        $allValuesRaw = ChannelTypeEnum::toArray();
